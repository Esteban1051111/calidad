...
<div class="container">
        <div class="card bg-dark custom-margin">
            <div class="card">
                <div class="card-header">LISTAR RADICADOS ENVIADOS O POR PROYECTO</div>
                <div class="card-body">
                    ...
                    <div class="mb-3">
                        ...
                        <div class="row mt-3">
                            ...
                            <div class="col-md-4">
                                <button type="button" class="btn btn-primary w-100" onclick="mostrarTabla('tablaRadicadosBorrador')">Listar Todos los Radicados Enviados</button>
                            </div>
                        </div>
                        <div class="row mt-3">
                            <div class="col-md-8 mb-3 mb-md-0">
