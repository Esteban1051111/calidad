...
<div class="card-container custom-margin">
  <div class="card" style="width: 15rem;">
    <a href="../radicacion/index.php" class="card-link">
      <img src="../../../img/Nuevoradicado.png" class="card-img-top" alt="graficos">
  ...
  <div class="card" style="width: 15rem;">
    <a href="../list_rad_enviados/index.php" class="card-link">
      <img src="../../../img/Consultar.png" class="card-img-top" alt="graficos">
      <div class="card-body text-center">
        <p class="card-text">Consultar Radicados Enviados</p>
      </div>
    </a>
  </div>
  
  <div class="card" style="width: 15rem;">
    <a href="../list_rad_borradores/index.php" class="card-link">
      <img src="../../../img/Modificar.png" class="card-img-top" alt="graficos">
      <div class="card-body text-center">
        <p class="card-text">Buscar Radicados en Borrador</p>
      </div>
    </a>
  </div>
</div>
