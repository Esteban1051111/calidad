...
<div class="container my-5">
  <div class="d-flex flex-row flex-nowrap overflow-auto">
    <div class="card custom-margin mx-2" style="width: 15rem;">
      <a href="../../../secciones/admin/crear_proyecto/index.php" class="card-link">
        <img src="../../../img/nuevoradicadop.jpg" class="card-img-top" alt="graficos">
        <div class="card-body text-center">
          <p class="card-text">Crear Proyecto</p>
        </div>
      </a>
    </div>
    <div class="card custom-margin mx-2" style="width: 15rem;">
      <a href="../../../secciones/admin/proyectos/index.php" class="card-link">
        <img src="../../../img/masivosp.jpg" class="card-img-top" alt="graficos">
        <div class="card-body text-center">
          <p class="card-text">Proyecto1</p>
        </div>
      </a>
    </div>
    <div class="card custom-margin mx-2" style="width: 15rem;">
